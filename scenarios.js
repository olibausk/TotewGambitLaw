...
export const scenarios = {
  ...
  schmuggel: {
    ...
    first: [
      ...
      { weight: 15, text: "Einem einsamen Reiter kommt es merkwürdig vor wie du dort unterwegs bist. Er reitet in höchstem Tempo zum nächsten Sheriffs Office und erstattet Meldung an das Gesetz. Die @Law machen sich auf den Weg zu der Stelle an der du gerade entdeckt wurdest und bekamen die Richtung vom Zeugen mitgeteilt in die du unterwegs bist. (Du musst dem Law einen Screenshot deiner Map schicken auf der deine Position zu erkennen ist und die Richtung in der du unterwegs bist, du darfst deinen Weg aber weiter fortsetzen und musst nicht warten, du bist selber aber nicht alarmiert darfst also nicht schneller werden als bisher)" },
  ...
  einbruch: {
    ...
    first: [
      ...
      { weight: 15, text: "Ein Nachbar hat verdächtige Geräusche gehört und schaut was los ist. (Ein neutraler Charakter (kein Law) bekommt deinen Standort und ihr spielt die Situation aus. Entweder der Zeuge alarmiert das Law, er lässt sich bestechen oder bedrohen, du kannst die Person als Geisel nehmen etc.)" },
